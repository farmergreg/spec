...
// Lookup look up a specification for the given Credit
...
// Generate a list of Credit specifications EXCLUDING those marked import only.
...
// Generate a list of all Credit specifications INCLUDING those marked import only.
func List() []Spec {
	return []Spec{
		internalMap[CQDX],
		internalMap[CQDXFIELD],
...
// internalMap is a map of all known Credit specifications
