...
// Lookup look up a specification for the given ARRLSection
...
// Generate a list of ARRLSection specifications EXCLUDING those marked import only.
...
// Generate a list of all ARRLSection specifications INCLUDING those marked import only.
func List() []Spec {
	return []Spec{
		internalMap[AB],
		internalMap[AK],
...
// internalMap is a map of all known ARRLSection specifications
