...
// All SecondaryAdministrativeSubdivision specifications INCLUDING those marked import only.
func List() []Spec {
	return []Spec{
...
// SecondaryAdministrativeSubdivision specifications EXCLUDING those marked import only.
