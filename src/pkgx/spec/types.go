...
import (
	...
	"github.com/hamradiolog-net/adif-spec/src/pkgx/enum/band"
	"github.com/hamradiolog-net/adif-spec/src/pkgx/enum/dxccentitycode"
	"github.com/hamradiolog-net/adif-spec/src/pkgx/enum/mode"
)
