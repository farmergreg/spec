...
var DataTypeMap = map[DataType]Spec{
...
var DataTypeListAll = []Spec{
	DataTypeMap[AwardList],
	DataTypeMap[Boolean],
	DataTypeMap[Character],
	DataTypeMap[CreditList],
	DataTypeMap[Date],
	DataTypeMap[Digit],
	DataTypeMap[Enumeration],
	DataTypeMap[GridSquare],
	DataTypeMap[GridSquareExt],
	DataTypeMap[GridSquareList],
	DataTypeMap[IOTARefNo],
	DataTypeMap[Integer],
	DataTypeMap[IntlCharacter],
	DataTypeMap[IntlMultilineString],
	DataTypeMap[IntlString],
	DataTypeMap[Location],
	DataTypeMap[MultilineString],
	DataTypeMap[Number],
	DataTypeMap[POTARef],
	DataTypeMap[POTARefList],
	DataTypeMap[PositiveInteger],
	DataTypeMap[SOTARef],
	DataTypeMap[SecondaryAdministrativeSubdivisionListAlt],
	DataTypeMap[SecondarySubdivisionList],
	DataTypeMap[SponsoredAwardList],
	DataTypeMap[String],
	DataTypeMap[Time],
	DataTypeMap[WWFFRef],
}
