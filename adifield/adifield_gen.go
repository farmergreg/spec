...
// Lookup locates the specification for the given ADIField
...
// ListActive returns a slice of ADIField specifications excluding those marked as import-only.
...
// List returns a slice of all ADIField specifications including those marked as import-only.
func List() []Spec {
