...
// Lookup look up a specification for the given ADIField
...
// Generate a list of ADIField specifications EXCLUDING those marked import only.
func ListActive() []Spec {
	return []Spec{
		internalMap[ADDRESS],
		internalMap[ADDRESS_INTL],
		internalMap[ADIF_VER],
		internalMap[AGE],
		internalMap[ALTITUDE],
		internalMap[ANT_AZ],
		internalMap[ANT_EL],
		internalMap[ANT_PATH],
		internalMap[APP_LOTW_2XQSL],
		internalMap[APP_LOTW_CQZ_INFERRED],
		internalMap[APP_LOTW_CQZ_INVALID],
		internalMap[APP_LOTW_CQZ_USERINVALID],
		internalMap[APP_LOTW_CREDIT_GRANTED],
		internalMap[APP_LOTW_CREDIT_SUBMITTED],
		internalMap[APP_LOTW_DXCC_ENTITY_STATUS],
		internalMap[APP_LOTW_EOF],
		internalMap[APP_LOTW_GRIDSQUARE_INVALID],
		internalMap[APP_LOTW_ITUZ_INFERRED],
		internalMap[APP_LOTW_ITUZ_INVALID],
		internalMap[APP_LOTW_ITUZ_USERINVALID],
		internalMap[APP_LOTW_LASTQSL],
		internalMap[APP_LOTW_LASTQSORX],
		internalMap[APP_LOTW_MODE],
		internalMap[APP_LOTW_MODEGROUP],
		internalMap[APP_LOTW_MY_DXCC_ENTITY_STATUS],
		internalMap[APP_LOTW_NPSUNIT],
		internalMap[APP_LOTW_NUMREC],
		internalMap[APP_LOTW_OWNCALL],
		internalMap[APP_LOTW_QSLMODE],
		internalMap[APP_LOTW_QSO_TIMESTAMP],
		internalMap[APP_LOTW_RXQSL],
		internalMap[APP_LOTW_RXQSO],
		internalMap[APP_QRZLOG_LOGID],
		internalMap[APP_QRZLOG_QSLDATE],
		internalMap[APP_QRZLOG_STATUS],
		internalMap[APP_SKCCLOGGER_KEYTYPE],
		internalMap[ARRL_SECT],
		internalMap[AWARD_GRANTED],
		internalMap[AWARD_SUBMITTED],
		internalMap[A_INDEX],
		internalMap[BAND],
		internalMap[BAND_RX],
		internalMap[CALL],
		internalMap[CHECK],
		internalMap[CLASS],
		internalMap[CLUBLOG_QSO_UPLOAD_DATE],
		internalMap[CLUBLOG_QSO_UPLOAD_STATUS],
		internalMap[CNTY],
		internalMap[CNTY_ALT],
		internalMap[COMMENT],
		internalMap[COMMENT_INTL],
		internalMap[CONT],
		internalMap[CONTACTED_OP],
		internalMap[CONTEST_ID],
		internalMap[COUNTRY],
		internalMap[COUNTRY_INTL],
		internalMap[CQZ],
		internalMap[CREATED_TIMESTAMP],
		internalMap[CREDIT_GRANTED],
		internalMap[CREDIT_SUBMITTED],
		internalMap[DARC_DOK],
		internalMap[DCL_QSLRDATE],
		internalMap[DCL_QSLSDATE],
		internalMap[DCL_QSL_RCVD],
		internalMap[DCL_QSL_SENT],
		internalMap[DISTANCE],
		internalMap[DXCC],
		internalMap[EMAIL],
		internalMap[EQSL_AG],
		internalMap[EQSL_QSLRDATE],
		internalMap[EQSL_QSLSDATE],
		internalMap[EQSL_QSL_RCVD],
		internalMap[EQSL_QSL_SENT],
		internalMap[EQ_CALL],
		internalMap[FISTS],
		internalMap[FISTS_CC],
		internalMap[FORCE_INIT],
		internalMap[FREQ],
		internalMap[FREQ_RX],
		internalMap[GRIDSQUARE],
		internalMap[GRIDSQUARE_EXT],
		internalMap[HAMLOGEU_QSO_UPLOAD_DATE],
		internalMap[HAMLOGEU_QSO_UPLOAD_STATUS],
		internalMap[HAMQTH_QSO_UPLOAD_DATE],
		internalMap[HAMQTH_QSO_UPLOAD_STATUS],
		internalMap[HRDLOG_QSO_UPLOAD_DATE],
		internalMap[HRDLOG_QSO_UPLOAD_STATUS],
		internalMap[IOTA],
		internalMap[IOTA_ISLAND_ID],
		internalMap[ITUZ],
		internalMap[K_INDEX],
		internalMap[LAT],
		internalMap[LON],
		internalMap[LOTW_QSLRDATE],
		internalMap[LOTW_QSLSDATE],
		internalMap[LOTW_QSL_RCVD],
		internalMap[LOTW_QSL_SENT],
		internalMap[MAX_BURSTS],
		internalMap[MODE],
		internalMap[MORSE_KEY_INFO],
		internalMap[MORSE_KEY_TYPE],
		internalMap[MS_SHOWER],
		internalMap[MY_ALTITUDE],
		internalMap[MY_ANTENNA],
		internalMap[MY_ANTENNA_INTL],
		internalMap[MY_ARRL_SECT],
		internalMap[MY_CITY],
		internalMap[MY_CITY_INTL],
		internalMap[MY_CNTY],
		internalMap[MY_CNTY_ALT],
		internalMap[MY_COUNTRY],
		internalMap[MY_COUNTRY_INTL],
		internalMap[MY_CQ_ZONE],
		internalMap[MY_DARC_DOK],
		internalMap[MY_DXCC],
		internalMap[MY_FISTS],
		internalMap[MY_GRIDSQUARE],
		internalMap[MY_GRIDSQUARE_EXT],
		internalMap[MY_IOTA],
		internalMap[MY_IOTA_ISLAND_ID],
		internalMap[MY_ITU_ZONE],
		internalMap[MY_LAT],
		internalMap[MY_LON],
		internalMap[MY_MORSE_KEY_INFO],
		internalMap[MY_MORSE_KEY_TYPE],
		internalMap[MY_NAME],
		internalMap[MY_NAME_INTL],
		internalMap[MY_POSTAL_CODE],
		internalMap[MY_POSTAL_CODE_INTL],
		internalMap[MY_POTA_REF],
		internalMap[MY_RIG],
		internalMap[MY_RIG_INTL],
		internalMap[MY_SIG],
		internalMap[MY_SIG_INFO],
		internalMap[MY_SIG_INFO_INTL],
		internalMap[MY_SIG_INTL],
		internalMap[MY_SOTA_REF],
		internalMap[MY_STATE],
		internalMap[MY_STREET],
		internalMap[MY_STREET_INTL],
		internalMap[MY_USACA_COUNTIES],
		internalMap[MY_VUCC_GRIDS],
		internalMap[MY_WWFF_REF],
		internalMap[NAME],
		internalMap[NAME_INTL],
		internalMap[NOTES],
		internalMap[NOTES_INTL],
		internalMap[NR_BURSTS],
		internalMap[NR_PINGS],
		internalMap[OPERATOR],
		internalMap[OWNER_CALLSIGN],
		internalMap[PFX],
		internalMap[POTA_REF],
		internalMap[PRECEDENCE],
		internalMap[PROGRAMID],
		internalMap[PROGRAMVERSION],
		internalMap[PROP_MODE],
		internalMap[PUBLIC_KEY],
		internalMap[QRZCOM_QSO_DOWNLOAD_DATE],
		internalMap[QRZCOM_QSO_DOWNLOAD_STATUS],
		internalMap[QRZCOM_QSO_UPLOAD_DATE],
		internalMap[QRZCOM_QSO_UPLOAD_STATUS],
		internalMap[QSLMSG],
		internalMap[QSLMSG_INTL],
		internalMap[QSLMSG_RCVD],
		internalMap[QSLRDATE],
		internalMap[QSLSDATE],
		internalMap[QSL_RCVD],
		internalMap[QSL_RCVD_VIA],
		internalMap[QSL_SENT],
		internalMap[QSL_SENT_VIA],
		internalMap[QSL_VIA],
		internalMap[QSO_COMPLETE],
		internalMap[QSO_DATE],
		internalMap[QSO_DATE_OFF],
		internalMap[QSO_RANDOM],
		internalMap[QTH],
		internalMap[QTH_INTL],
		internalMap[REGION],
		internalMap[RIG],
		internalMap[RIG_INTL],
		internalMap[RST_RCVD],
		internalMap[RST_SENT],
		internalMap[RX_PWR],
		internalMap[SAT_MODE],
		internalMap[SAT_NAME],
		internalMap[SFI],
		internalMap[SIG],
		internalMap[SIG_INFO],
		internalMap[SIG_INFO_INTL],
		internalMap[SIG_INTL],
		internalMap[SILENT_KEY],
		internalMap[SKCC],
		internalMap[SOTA_REF],
		internalMap[SRX],
		internalMap[SRX_STRING],
		internalMap[STATE],
		internalMap[STATION_CALLSIGN],
		internalMap[STX],
		internalMap[STX_STRING],
		internalMap[SUBMODE],
		internalMap[SWL],
		internalMap[TEN_TEN],
		internalMap[TIME_OFF],
		internalMap[TIME_ON],
		internalMap[TX_PWR],
		internalMap[UKSMG],
		internalMap[USACA_COUNTIES],
		internalMap[USERDEF1],
		internalMap[USERDEF2],
		internalMap[USERDEF3],
		internalMap[USERDEF4],
		internalMap[USERDEF5],
		internalMap[USERDEF6],
		internalMap[USERDEF7],
		internalMap[USERDEF8],
		internalMap[USERDEF9],
		internalMap[VUCC_GRIDS],
		internalMap[WEB],
		internalMap[WWFF_REF],
	}
}

// Generate a list of all ADIField specifications INCLUDING those marked import only.
func List() []Spec {
	return []Spec{
		internalMap[ADDRESS],
		internalMap[ADDRESS_INTL],
...
// internalMap is a map of all known ADIField specifications
var internalMap = map[ADIField]Spec{
