...
import (
	...
	"github.com/hamradiolog-net/spec/v6/enum/antpath"
	"github.com/hamradiolog-net/spec/v6/enum/arrlsection"
	"github.com/hamradiolog-net/spec/v6/enum/award"
	"github.com/hamradiolog-net/spec/v6/enum/awardsponsor"
	"github.com/hamradiolog-net/spec/v6/enum/band"
	"github.com/hamradiolog-net/spec/v6/enum/contest"
	"github.com/hamradiolog-net/spec/v6/enum/continent"
	"github.com/hamradiolog-net/spec/v6/enum/credit"
	"github.com/hamradiolog-net/spec/v6/enum/dxccentitycode"
	"github.com/hamradiolog-net/spec/v6/enum/eqslag"
	"github.com/hamradiolog-net/spec/v6/enum/mode"
	"github.com/hamradiolog-net/spec/v6/enum/morsekeytype"
	"github.com/hamradiolog-net/spec/v6/enum/primaryadministrativesubdivision"
	"github.com/hamradiolog-net/spec/v6/enum/propagationmode"
	"github.com/hamradiolog-net/spec/v6/enum/qslmedium"
	"github.com/hamradiolog-net/spec/v6/enum/qslrcvd"
	"github.com/hamradiolog-net/spec/v6/enum/qslsent"
	"github.com/hamradiolog-net/spec/v6/enum/qslvia"
	"github.com/hamradiolog-net/spec/v6/enum/qsocomplete"
	"github.com/hamradiolog-net/spec/v6/enum/qsodownloadstatus"
	"github.com/hamradiolog-net/spec/v6/enum/qsouploadstatus"
	"github.com/hamradiolog-net/spec/v6/enum/region"
	"github.com/hamradiolog-net/spec/v6/enum/secondaryadministrativesubdivision"
	"github.com/hamradiolog-net/spec/v6/enum/secondaryadministrativesubdivisionalt"
