...
import (
	...
	"github.com/hamradiolog-net/adif-spec/v3/aditype"
	"github.com/hamradiolog-net/adif-spec/v3/enum/antpath"
	"github.com/hamradiolog-net/adif-spec/v3/enum/arrlsection"
	"github.com/hamradiolog-net/adif-spec/v3/enum/award"
	"github.com/hamradiolog-net/adif-spec/v3/enum/awardsponsor"
	"github.com/hamradiolog-net/adif-spec/v3/enum/band"
	"github.com/hamradiolog-net/adif-spec/v3/enum/contest"
	"github.com/hamradiolog-net/adif-spec/v3/enum/continent"
	"github.com/hamradiolog-net/adif-spec/v3/enum/credit"
	"github.com/hamradiolog-net/adif-spec/v3/enum/dxccentitycode"
	"github.com/hamradiolog-net/adif-spec/v3/enum/eqslag"
	"github.com/hamradiolog-net/adif-spec/v3/enum/mode"
	"github.com/hamradiolog-net/adif-spec/v3/enum/morsekeytype"
	"github.com/hamradiolog-net/adif-spec/v3/enum/primaryadministrativesubdivision"
	"github.com/hamradiolog-net/adif-spec/v3/enum/propagationmode"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qslmedium"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qslrcvd"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qslsent"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qslvia"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qsocomplete"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qsodownloadstatus"
	"github.com/hamradiolog-net/adif-spec/v3/enum/qsouploadstatus"
	"github.com/hamradiolog-net/adif-spec/v3/enum/region"
	"github.com/hamradiolog-net/adif-spec/v3/enum/secondaryadministrativesubdivision"
	"github.com/hamradiolog-net/adif-spec/v3/enum/secondaryadministrativesubdivisionalt"
