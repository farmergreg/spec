...
import (
	"github.com/hamradiolog-net/adif-spec/v2/adifield"
	"github.com/hamradiolog-net/adif-spec/v2/aditype"
	"github.com/hamradiolog-net/adif-spec/v2/enum/antpath"
	"github.com/hamradiolog-net/adif-spec/v2/enum/arrlsection"
	"github.com/hamradiolog-net/adif-spec/v2/enum/award"
	"github.com/hamradiolog-net/adif-spec/v2/enum/awardsponsor"
	"github.com/hamradiolog-net/adif-spec/v2/enum/band"
	"github.com/hamradiolog-net/adif-spec/v2/enum/contest"
	"github.com/hamradiolog-net/adif-spec/v2/enum/continent"
	"github.com/hamradiolog-net/adif-spec/v2/enum/credit"
	"github.com/hamradiolog-net/adif-spec/v2/enum/dxccentitycode"
	"github.com/hamradiolog-net/adif-spec/v2/enum/eqslag"
	"github.com/hamradiolog-net/adif-spec/v2/enum/mode"
	"github.com/hamradiolog-net/adif-spec/v2/enum/morsekeytype"
	"github.com/hamradiolog-net/adif-spec/v2/enum/primaryadministrativesubdivision"
	"github.com/hamradiolog-net/adif-spec/v2/enum/propagationmode"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qslmedium"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qslrcvd"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qslsent"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qslvia"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qsocomplete"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qsodownloadstatus"
	"github.com/hamradiolog-net/adif-spec/v2/enum/qsouploadstatus"
	"github.com/hamradiolog-net/adif-spec/v2/enum/region"
	"github.com/hamradiolog-net/adif-spec/v2/enum/secondaryadministrativesubdivision"
	"github.com/hamradiolog-net/adif-spec/v2/enum/secondaryadministrativesubdivisionalt"
	"github.com/hamradiolog-net/adif-spec/v2/enum/submode"
